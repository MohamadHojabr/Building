...
namespace Building.Web.Mvc.Controllers
{
    public partial class AddressesController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public AddressesController Actions { get { return MVC.Addresses; } }
        ...
        public class ViewsClass
        {
            ...
            public readonly string Create = "~/Views/Addresses/Create.cshtml";
            public readonly string Delete = "~/Views/Addresses/Delete.cshtml";
            public readonly string Details = "~/Views/Addresses/Details.cshtml";
            public readonly string Edit = "~/Views/Addresses/Edit.cshtml";
            public readonly string Index = "~/Views/Addresses/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AddressesController : Building.Web.Mvc.Controllers.AddressesController
    {
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, DomainClasses.Models.Address address);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(DomainClasses.Models.Address address)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, DomainClasses.Models.Address address);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(DomainClasses.Models.Address address)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "address", address);
            EditOverride(callInfo, address);
            return callInfo;
        }
